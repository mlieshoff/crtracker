...
public class MeasureDao {
    ...
    private StringMeasure internUpdateStringMeasure(Session session, long hash, int measureType, String value, Date modifiedAt) {
        ...
        List<StringMeasure> old = (List<StringMeasure>) session.createQuery("from " + StringMeasure.class.getName() + " t where t.measureId.hash=:hash and t.measureId.type=:type order by modifiedAt desc")
                .setLong("hash", measureId.getHash())
                .setInteger("type", measureId.getType())
                .setMaxResults(1)
                .list();
    ...
    private NumberMeasure internUpdateNumberMeasure(Session session, long hash, int measureType, long value, Date date) {
        MeasureId measureId = new MeasureId();
        measureId.setHash(hash);
        ...
        List<NumberMeasure> old = (List<NumberMeasure>) session.createQuery("from " + NumberMeasure.class.getName() + " t where t.measureId.hash=:hash and t.measureId.type=:type order by modifiedAt desc")
                .setLong("hash", measureId.getHash())
                .setInteger("type", measureId.getType())
                .setMaxResults(1)
                .list();
    ...
    public DecimalMeasure updateDecimalMeasure(Session session, String id, int measureType, double value, Date modifiedAt) {
        long hash = Hashing.md5().hashString(id, Charset.forName("UTF-8")).asLong();
        saveId(session, id, hash);
        return internUpdateDecimalMeasure(session, hash, measureType, value, modifiedAt);
    }

    private DecimalMeasure internUpdateDecimalMeasure(Session session, long hash, int measureType, double value, Date modifiedAt) {
        MeasureId measureId = new MeasureId();
        measureId.setHash(hash);
        measureId.setModifiedAt(modifiedAt);
        measureId.setType(measureType);
        ...
        List<DecimalMeasure> old = (List<DecimalMeasure>) session.createQuery("from " + DecimalMeasure.class.getName() + " t where t.measureId.hash=:hash and t.measureId.type=:type order by t.measureId.modifiedAt desc")
                .setLong("hash", measureId.getHash())
                .setInteger("type", measureId.getType())
                .setMaxResults(1)
                .list();
   ...
   private TextMeasure internUpdateTextMeasure(Session session, long hash, int measureType, String value, Date modifiedAt) {
        MeasureId measureId = new MeasureId();
        measureId.setHash(hash);
        measureId.setModifiedAt(modifiedAt);
        measureId.setType(measureType);
        ...
        List<TextMeasure> old = (List<TextMeasure>) session.createQuery("from " + TextMeasure.class.getName() + " t where t.measureId.hash=:hash and t.measureId.type=:type order by modifiedAt desc")
                .setLong("hash", measureId.getHash())
                .setInteger("type", measureId.getType())
                .setMaxResults(1)
                .list();
    ...
    public StringMeasure getCurrentStringMeasure(Session session, MeasureType measureType, String id) {
        long hash = Hashing.md5().hashString(id, Charset.forName("UTF-8")).asLong();
        return (StringMeasure) session.createQuery("from " + StringMeasure.class.getName() + " t where t.measureId.hash=:hash and t.measureId.type=:type order by t.measureId.modifiedAt desc")
                .setLong("hash", hash)
                .setInteger("type", measureType.getCode())
                .setMaxResults(1)
                .uniqueResult();
    }
    ...
    public List<StringMeasure> getLastStringMeasures(Session session, MeasureType measureType, String id, int limit) {
        long hash = Hashing.md5().hashString(id, Charset.forName("UTF-8")).asLong();
        return session.createQuery("from " + StringMeasure.class.getName() + " t where t.measureId.hash=:hash and t.measureId.type=:type order by t.measureId.modifiedAt desc")
                .setLong("hash", hash)
                .setInteger("type", measureType.getCode())
                .setMaxResults(limit)
                .list();
    ...
    public List<TextMeasure> getLastTextMeasures(Session session, MeasureType measureType, String id, int limit) {
        long hash = Hashing.md5().hashString(id, Charset.forName("UTF-8")).asLong();
        return session.createQuery("from " + TextMeasure.class.getName() + " t where t.measureId.hash=:hash and t.measureId.type=:type order by t.measureId.modifiedAt desc")
                .setLong("hash", hash)
                .setInteger("type", measureType.getCode())
                .setMaxResults(limit)
                .list();
    ...
    public NumberMeasure getCurrentNumberMeasure(Session session, MeasureType measureType, String id) {
        long hash = Hashing.md5().hashString(id, Charset.forName("UTF-8")).asLong();
        return (NumberMeasure) session.createQuery("from " + NumberMeasure.class.getName() + " t where t.measureId.hash=:hash and t.measureId.type=:type order by modifiedAt desc")
                .setLong("hash", hash)
                .setInteger("type", measureType.getCode())
                .setMaxResults(1)
                .uniqueResult();
    ...
    public TextMeasure getCurrentTextMeasure(Session session, MeasureType measureType, String id) {
        long hash = Hashing.md5().hashString(id, Charset.forName("UTF-8")).asLong();
        return (TextMeasure) session.createQuery("from " + TextMeasure.class.getName() + " t where t.measureId.hash=:hash and t.measureId.type=:type order by t.measureId.modifiedAt desc")
                .setLong("hash", hash)
                .setInteger("type", measureType.getCode())
                .setMaxResults(1)
                .uniqueResult();
    ...
    public List<NumberMeasure> getLastNumberMeasures(Session session, MeasureType measureType, String id, int limit) {
        long hash = Hashing.md5().hashString(id, Charset.forName("UTF-8")).asLong();
        return session.createQuery("from " + NumberMeasure.class.getName() + " t where t.measureId.hash=:hash and t.measureId.type=:type order by modifiedAt desc")
                .setLong("hash", hash)
                .setInteger("type", measureType.getCode())
                .setMaxResults(limit)
                .list();
    ...
    public NumberMeasure getLastNumberMeasure(Session session, MeasureType measureType, String id, DateTime from, DateTime to) {
        long hash = Hashing.md5().hashString(id, Charset.forName("UTF-8")).asLong();
        return (NumberMeasure) session.createQuery("from " + NumberMeasure.class.getName() + " t where t.measureId.hash=:hash and t.measureId.type=:type and modifiedAt>=:from and modifiedAt<=:to order by modifiedAt desc")
                .setLong("hash", hash)
                .setInteger("type", measureType.getCode())
    ...
    public Long getCountDecimalMeasures(Session session) {
        return ((BigInteger) session.createSQLQuery("select count(*) from measure_decimals").uniqueResult()).longValue();
    }
