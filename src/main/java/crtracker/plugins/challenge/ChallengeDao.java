...
public class ChallengeDao {
  ...
  public Map<Long, ChallengeDefinition> getActiveChallengeDefinitions(Session session) {
    List<ChallengeDefinition>
        list =
        session.createQuery("from " + ChallengeDefinition.class.getName() + " t where t.active=:active")
  ...
  public List<RunningChallenge> getRunningChallenges(Session session) {
    return session
        .createQuery("from " + RunningChallenge.class.getName() + " t where t.challengeStatus=:challengeStatus")
